...
This is an attempt to complete the task assigned for appointy recruitment. 

## Getting Started 🎧

This project utilized the benefits of multiple technologies such as Go, net/http, and mongodb
### Prerequisites
...
Run the following command in the terminal after you CD into the directory. 
```
nodemon --exec go run main.go --signal SIGTERM     
```

## Built With 🎯
**A lot of love and a little Golang**
